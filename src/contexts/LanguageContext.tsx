...
const translations = {
  es: {
    ...
    'services.clinical.trigger.title': 'Masaje de Puntos Gatillo',
    'services.clinical.trigger.desc': 'Alivio específico para puntos de tensión muscular',
    'services.clinical.deep.title': 'Masaje de Tejido Profundo',
    'services.clinical.deep.desc': 'Técnica intensiva para liberar tensiones profundas',
    'services.clinical.lymphatic.title': 'Drenaje Linfático',
    'services.clinical.lymphatic.desc': 'Estimulación del sistema linfático para eliminar toxinas',
    'services.clinical.myofascial.title': 'Liberación Miofascial',
    'services.clinical.myofascial.desc': 'Técnica para liberar la fascia y mejorar la movilidad',
    ...
    'services.relaxing.swedish.desc': 'Técnica clásica para relajación general',
    'services.relaxing.aromatherapy.title': 'Masaje con Aromaterapia',
    'services.relaxing.aromatherapy.desc': 'Combinación de masaje y aceites esenciales',
    ...
    'services.relaxing.stones.desc': 'Terapia relajante que utiliza piedras volcánicas calientes para aliviar la tensión muscular y promover la relajación profunda.',
    ...
    'services.corporate.shiatsu.title': 'Shiatsu en Silla',
    'services.corporate.shiatsu.desc': 'Masaje rápido y efectivo para trabajadores de oficina',
  ...
  en: {
    ...
    'services.specialized.desc': 'Professional therapeutic massage focused on specific conditions and injuries',
    ...
    'services.clinical.trigger.desc': 'Specific relief for muscle tension points',
    'services.clinical.deep.title': 'Deep Tissue Massage',
    'services.clinical.deep.desc': 'Intensive technique to release deep tensions',
    'services.clinical.lymphatic.title': 'Lymphatic Drainage',
    'services.clinical.lymphatic.desc': 'Stimulation of the lymphatic system to eliminate toxins',
    'services.clinical.myofascial.title': 'Myofascial Release',
    'services.clinical.myofascial.desc': 'Technique to release fascia and improve mobility',
    'services.clinical.hormonal.title': 'Hormonal Change Massage',
    'services.clinical.hormonal.desc': 'Designed for women in menopause, helps calm symptoms such as hot flashes, sleep problems, depression and anxiety, improving circulation and reducing stress.',
    'services.clinical.prenatal.title': 'Prenatal Massage',
    'services.clinical.prenatal.desc': 'Body therapy focused on the needs of pregnant women, relieves discomfort during pregnancy and helps release endorphins, compensating for the energy that the mother loses.',
    ...
    'services.relaxing.swedish.desc': 'Classical technique for general relaxation',
    'services.relaxing.aromatherapy.title': 'Aromatherapy Massage',
    'services.relaxing.aromatherapy.desc': 'Combination of massage and essential oils',
    ...
    'services.corporate.shiatsu.title': 'Chair Shiatsu',
    'services.corporate.shiatsu.desc': 'Quick and effective massage for office workers',
