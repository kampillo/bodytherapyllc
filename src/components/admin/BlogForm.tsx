...
const BlogForm: React.FC<BlogFormProps> = ({ post, isEdit = false }) => {
  ...
  // Actualizar el editor cuando cambie el contenido inicial
  React.useEffect(() => {
                    ...
                    <div className="border-b border-gray-300 bg-gray-50 p-2 flex flex-wrap gap-2">
                      ...
                      >
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 12h4a2 2 0 100-4H6v4zm0 0h4a2 2 0 110 4H6v-4z" />
                        </svg>
                      </button>
                      <button
                        type="button"
