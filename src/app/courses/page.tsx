  ...
  return (
    <>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <p className="ml-3 text-dark/80">{t.training.feature1}</p>
                </div>
                <div className="flex items-center">
                  <div className="flex-shrink-0 h-6 w-6 text-secondary-600">
                    <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <p className="ml-3 text-dark/80">{t.training.feature2}</p>
                </div>
                <div className="flex items-center">
                  <div className="flex-shrink-0 h-6 w-6 text-secondary-600">
                    <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <p className="ml-3 text-dark/80">{t.training.feature3}</p>
                </div>
                <div className="flex items-center">
                  <div className="flex-shrink-0 h-6 w-6 text-secondary-600">
                    <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <p className="ml-3 text-dark/80">{t.training.feature4}</p>
                </div>
              </div>
            </div>
                ...
                <div className="md:w-2/3">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                    <div className="bg-primary-50 p-3 rounded-lg">
                      <span className="text-sm font-medium text-dark/60 block">{t.details.duration}</span>
                      <span className="text-primary-800 font-medium">{course.duration}</span>
                    </div>
                    <div className="bg-primary-50 p-3 rounded-lg">
                      <span className="text-sm font-medium text-dark/60 block">{t.details.level}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-soft p-8 hover:shadow-hover transition-all">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  <h4 className="text-lg font-semibold text-primary-800">{t.testimonials.testimonial1.name}</h4>
                  <p className="text-dark/60">{t.testimonials.testimonial1.role}</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-soft p-8 hover:shadow-hover transition-all">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  <h4 className="text-lg font-semibold text-primary-800">{t.testimonials.testimonial2.name}</h4>
                  <p className="text-dark/60">{t.testimonials.testimonial2.role}</p>
                </div>
              </div>
              <p className="text-dark/70">
            ...
            <div className="bg-white rounded-xl shadow-soft p-8 hover:shadow-hover transition-all">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  <h4 className="text-lg font-semibold text-primary-800">{t.testimonials.testimonial3.name}</h4>
                  <p className="text-dark/60">{t.testimonials.testimonial3.role}</p>
                </div>
              </div>
              <p className="text-dark/70">
              ...
              <table className="min-w-full">
                <thead>
                  <tr className="bg-primary-700 text-white">
                    <th className="py-3 px-6 text-left">{t.table.course}</th>
                    <th className="py-3 px-6 text-left">{t.table.start}</th>
                    <th className="py-3 px-6 text-left">{t.table.duration}</th>
                    <th className="py-3 px-6 text-left">{t.table.price}</th>
                    <th className="py-3 px-6 text-left">{t.table.availability}</th>
                    <th className="py-3 px-6 text-center">{t.table.action}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-gray-200 hover:bg-primary-50 transition-colors">
                    ...
                    <td className="py-4 px-6">{t.schedule.mti.date}</td>
                    <td className="py-4 px-6">{t.schedule.mti.duration}</td>
                    ...
                    <td className="py-4 px-6 text-center">
                      <Button href="/contact?course=MTI" variant="outline" size="sm">
                        {t.availability.register}
                      </Button>
                    </td>
                  </tr>
                  <tr className="border-b border-gray-200 hover:bg-primary-50 transition-colors">
                    <td className="py-4 px-6 font-medium">{t.courses.upper.title}</td>
                    <td className="py-4 px-6">{t.schedule.upper.date}</td>
                    <td className="py-4 px-6">{t.schedule.upper.duration}</td>
                  ...
                  <tr className="hover:bg-primary-50 transition-colors">
                    ...
                    <td className="py-4 px-6">{t.schedule.lower.date}</td>
                    <td className="py-4 px-6">{t.schedule.lower.duration}</td>
                    <td className="py-4 px-6 font-medium">$150.00</td>
                    <td className="py-4 px-6">
                      <span className="px-2 py-1 bg-yellow-100 text-yellow-800 rounded-full text-xs font-medium">
                        {t.availability.few}
          ...
          <div className="bg-white rounded-xl shadow-soft p-6 mt-8">
            <div className="flex flex-col md:flex-row items-center gap-6">
              <div className="md:w-8/12">
                <h3 className="text-xl font-bold text-primary-800 mb-2">{t.package.title}</h3>
                <p className="text-dark/70">
      ...
      <section className="py-20 bg-primary-800 text-black relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6">{t.cta.title}</h2>
